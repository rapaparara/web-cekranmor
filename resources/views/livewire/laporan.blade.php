        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-body">
                    ...
                    <button wire:click="editStateModal()" type="button" class="btn btn-sm btn-success mb-3"
                        data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                        <span class="bi-plus-circle-fill me-1"></span>Tambah Data
                    </button>
                    <input wire:model.live="katakunci" type="text" class="form-control mb-3" placeholder="Search...">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($dataLaporans as $key => $value)
                                    <tr>
                                        <th scope="row">{{ $dataLaporans->firstItem() + $key }}</th>
                                        ...
                                        <td>
                                            <button wire:click.prevent="edit('{{ $value->id }}')" type="button"
                                                ...
                                                data-bs-target="#staticBackdrop"><small><span
                                                        class="bi-pencil-square"></span></small></button>
                                            <button wire:click.prevent="delete('{{ $value->id }}')" type="button"
                                                class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal"><small><span
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input wire:model="form.tanggal_melapor" type="datetime-local" class="form-control"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input wire:model="form.umur" type="text" class="form-control" id="umur" name="umur"
                            required>
                        @error('form.umur')
                            <small class="text-danger d-block mt-1">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input wire:model="form.alamat_pelapor" type="text" class="form-control" id="alamat_pelapor"
                            name="alamat_pelapor" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input wire:model="form.pasal_pidana" type="text" class="form-control" id="pasal_pidana"
                            name="pasal_pidana" required>
                        @error('form.pasal_pidana')
                            <small class="text-danger d-block mt-1">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group mb-3">
                        <label for="identitas_pelapor">Identitas Terlapor</label>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input wire:model="form.perkembangan" type="text" class="form-control" id="perkembangan"
                            name="perkembangan" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input wire:model="form.identitas_pemilik" type="text" class="form-control"
                            id="identitas_pemilik" name="identitas_pemilik">
