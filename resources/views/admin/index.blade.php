...
<div class="w-full mb-3 ml-1">
    <h5 class="text-3xl font-bold tracking-tight text-cyan-800 dark:text-white">Menu title</h5>
</div>
<div class="w-full p-4 mb-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut vitae rem eius nobis non eligendi eaque distinctio ab, ullam labore, sit sunt deleniti tempora modi odio expedita dolor earum? Quis?</p>
</div>
